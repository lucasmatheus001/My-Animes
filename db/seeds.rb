...
anime1 = Anime.new(name: "One Piece", description: "Gol D. Roger was known as the "Pirate King," the stron
    gest and most infamous being to have sailed the Grand Line. The capture and execution of Roger by the World Govern
    ment brought a change throughout the world. His last words before his death revealed the existence of the greatest
     treasure in the world, One Piece. It was this revelation that brought about the Grand Age of Pirates, men who dre
    amed of finding One Piece—which promises an unlimited amount of riches and fame—and quite possibly the pinnacle of
     glory and the title of the Pirate King. Enter Monkey D. Luffy, a 17-year-old boy who defies your standard definit
    ion of a pirate",image_url:"https://cdn.myanimelist.net/images/anime/6/73245.jpg",genres: "Acao e aventura",episod
    es: 300,studios: "Toey Animation",duration: 21, situation: "Em andamento",user_id: 2)

anime1.save

anime2 = Anime.new(name: "Youjo Senki II", description: ""Saga of Tanya the Evil, ou no Japão Yōjo Senki (幼女戦記?, lit. \"Crônicas Militares de uma Pequena Garota\"), é uma light novel japonesa escrita por Carlo Zen e ilustrada por Shinobu Shinotsuki. A publicadora Enterbrain publicou doze volumes a partir de 31 de outubro de 2013. Uma adaptação para mangá com arte de Chika Tōjō começou a serialização em Kadokawa Shoten Comp Ace Magazine em 26 de abril de 2016. Uma adaptação de anime pela NUT estreou em 6 de janeiro de 2017."",image_url:"https://cdn.myanimelist.net/images/anime/1437/115925.jpg",genres: "Acao e aventura",episodes
: 500,studios: "Toey Animation",duration: 21, situation: "Em andamento",user_id: 2)
anime2.save
